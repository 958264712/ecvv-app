<template>
	<scroll-view scroll-y>
		<uni-forms ref="form" :modelValue="formData" :rules="rules" :label-width="90">
			<view>
				<uni-title type="h4" :title="$t('inquiryItem.basic-info')" style="margin-left: 10px;"></uni-title>
				<view style="background-color: #fff;padding: 10px;margin: 10px;">
					<uni-forms-item :label="$t('inquiryItem.subject')" name="subject" required>
			...
			<view>
				...
				<view style="background-color: #fff;padding: 10px;margin: 10px;">
					...
					<uni-forms-item :label="$t('inquiryItem.country')" name="country" required>
						<uni-data-select v-model="value" :localdata="range"
							:placeholder="$t('inquiryItem.place-change')" @change="change"></uni-data-select>
					</uni-forms-item>
					...
					<uni-forms-item :label="$t('inquiryItem.address')" name="address" required>
						<uni-data-select v-model="value" :localdata="range"
							:placeholder="$t('inquiryItem.place-change')" @change="change"> </uni-data-select>
					</uni-forms-item>
					...
					<uni-forms-item :label="$t('inquiryItem.fax-telephone')" name="faxtelephone">
						<uni-easyinput class="input" v-model="formData.time" type="text"
							:placeholder="$t('inquiryItem.place-input')" />
					</uni-forms-item>
				</view>
			...
			<view class="u-m-l-20">
				<uni-forms-item label-width="0" label="" name="radio1" style="margin-bottom: 5px;">
					<view class="u-flex">
						<input type="radio" v-model="formData.radio1" />{{$t('inquiryItem.radio1')}}
					</view>
				</uni-forms-item>
				<uni-forms-item label-width="0" label="" name="radio2">
				<view class="u-flex">
					<input type="radio" v-model="formData.radio2" />{{$t('inquiryItem.radio2')}}
				</view>
				</uni-forms-item>
			</view>
			<view class="u-flex u-row-center u-m-20">
