...
.coupon-box {
	...
	.coupon-card {
		...
		border-radius: 10rpx;
		mask: url('https://file.shopro.top'+'/imgs/coupon_mini_bg.png');
		-webkit-mask-box-image: url('https://file.shopro.top'+'/imgs/coupon_mini_bg.png');
		mask-size: 100% 100%;
		.card-left {
			height: 100%;
			width: 260rpx;
...
// 未领取，已领取
.coupon-wrap {
	mask: url('https://file.shopro.top'+'/imgs/coupon_bg1.png');
	-webkit-mask-box-image: url('https://file.shopro.top'+'/imgs/coupon_bg1.png');
	mask-size: 100% 100%;
	position: relative;
	border-radius: 10rpx;
	width: 710rpx;
